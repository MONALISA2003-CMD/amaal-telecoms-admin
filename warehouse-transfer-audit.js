...
const checks=[
 ...
 ['ship moves serialized units to transit state',/status='Transferred',location_id=NULL/.test(server)],
 ...
 ['receive restores exact units at destination',/status='In Stock',location_id=\$1/.test(server)],
