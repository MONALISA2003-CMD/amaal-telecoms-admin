...
const checks=[
 ...
 ['sales transition to sold exists',/toStatus:'Sold'/.test(sales)&&/sale_serial_units/.test(sales)],
 ['delivery accepts reserved serialized units',/toStatus:'Sold'/.test(delivery)&&/unit_status!=='Reserved'/.test(delivery)&&/delivery_shipment_serial_units/.test(delivery)],
