...
const checks = [
 ...
 ['assignment changes unit to Reserved', orders.includes("toStatus:'Reserved'") && orders.includes('transitionSerializedUnit')],
 ...
 ['fulfilment accepts Reserved assigned units and marks Sold', orders.includes("toStatus:'Sold'") && orders.includes('OrderFulfillment')],
