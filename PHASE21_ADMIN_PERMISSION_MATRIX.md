...
Generated: 2026-08-28T18:11:08.462Z
...
| catalog.view | View product catalog | 14 | View | Backend-only / contextual |
| catalog.manage | Manage product catalog | 30 | Create/Execute, Edit, Delete/Archive, Bulk/Create | Yes |
...
| customers.view | View customers | 0 | UI/permission only | Backend-only / contextual |
| customers.manage | Manage customers | 0 | UI/permission only | Yes |
...
- Permission registry: **134** entries discovered from the backend source.
- Guarded API routes: **131**.
