...
export const newProducts: HomeProduct[] = [
  {
    ...
    quickDetails: ['16GB RAM', '256GB storage'],
    variants: [{ label: '256GB · 16GB RAM', price: 5250000 }],
  ...
  },
  {
    ...
    variants: [
      { label: '12GB RAM + 256GB ROM', price: 6100000 },
      { label: '12GB RAM + 512GB ROM', price: 7700000 },
      { label: '16GB RAM + 1TB Storage', price: 9200000 },
    ],
  ...
  },
  {
    ...
    variants: [
      { label: '12GB RAM + 256GB ROM', price: 7650000 },
      { label: '12GB RAM + 512GB ROM', price: 8300000 },
      { label: '16GB RAM + 1TB Storage', price: 10000090 },
    ],
