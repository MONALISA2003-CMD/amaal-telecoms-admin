  ...
  return <main><SiteHeader />
    <section className="phone-home-v2-hero">
      <div className="phone-home-v2-hero-copy">
        ...
        <p>Explore Amaal&apos;s phone collection by brand, series and model. One clear collection, with every available choice kept together.</p>
      </div>
      <div className="phone-home-v2-search-wrap">
        ...
        <div className="phone-home-v2-search-hint"><Sparkles size={14}/> Search by model, series, storage or memory</div>
      </div>
    </section>
