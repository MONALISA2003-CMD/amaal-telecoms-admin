  ...
  return <main><SiteHeader />
    <section className="phone-home-v2-hero">
      <div className="phone-home-v2-hero-copy">
        ...
        <p>Browse every Amaal phone by brand, series, model and available configuration.</p>
      </div>
      <div className="phone-home-v2-search-wrap">
        <label htmlFor="phone-home-search">Search all phones</label>
        ...
        <div className="phone-home-v2-search-hint"><Sparkles size={14}/> Search by model, brand, series or configuration</div>
      </div>
    </section>
