...
export default function KitchenAppliancesPage(){
 ...
 return <main><SiteHeader/><section className="section appliance-landing">
  ...
  <div className="appliance-landing-hero"><div className="appliance-landing-head"><div><p className="eyebrow">KITCHEN APPLIANCES</p><h1>Better tools for better cooking.</h1><p className="listingLead">Cook, blend, bake, brew and prepare with a deliberately organized kitchen catalogue.</p></div><div className="appliance-stat"><strong>{kitchenApplianceProducts.length}</strong><span>catalogue entries</span></div></div></div>
